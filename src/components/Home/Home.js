...
class Welcome extends Component {
	...
	initializePanels() {
		return [{name: 'Witness Feed', img: 'fas fa-crown fa-2x', minSize: 'small', size: 'large', visible: true, id: 0, gridPlacement: {i: '0', x: this.startingX, y: 5, w: 24, h: 24.5}},
			...
			{name: 'Fee Schedule', img: 'fas fa-file-invoice-dollar fa-2x', minSize:'medium', size: '', visible: false, id:4, gridPlacement: {i: '4', x: this.startingX, y: 0, w: 24, h: 20}},
			...
			{name: 'Committee Feed', img: 'fas fa-sitemap fa-2x', minSize:'small', size: '', visible: false, id: 6, gridPlacement: {i: '6', x: this.startingX, y: 0, w: 24, h: 24}}];
	}
